<template>
  <div>
    <!-- Return Button -->
    <button @click="goHome" class="return-button bg-blue-500 text-white px-4 py-2 rounded mb-4">
      Return to Home Page
    </button>
...
// Dummy user role - replace with store or props in real apps
const userRole = ref('Admin') // or 'User'
